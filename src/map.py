...
def printMap(V):
    ...
    for superarch in superarchers:
        a= 2*superarch.position[0]
        b = 2*superarch.position[1]
        if(time.time()-superarch.timestart<10):
            map_matrix[a][b] = archColor(superarch) + Fore.BLACK + 'IN'
            map_matrix[a+1][b] = archColor(superarch) + Fore.BLACK + 'VI'
            map_matrix[a][b+1] = archColor(superarch) + Fore.BLACK + 'AB'
            map_matrix[a+1][b+1] = archColor(superarch) + Fore.BLACK + 'LE'
        else:
            map_matrix[a][b] = archColor(superarch) + Fore.BLACK + '  '
            map_matrix[a+1][b] = archColor(superarch) + Fore.BLACK + 'VI'
            map_matrix[a][b+1] = archColor(superarch) + Fore.BLACK + 'AB'
            map_matrix[a+1][b+1] = archColor(superarch) + Fore.BLACK + 'LE'
    ...
    for bl in healers:
        a= 2*bl.position[0]
        b = 2*bl.position[1]
        map_matrix[a][b] = blColor(bl) + Fore.BLACK + 'HE'
        map_matrix[a+1][b] = blColor(bl) + Fore.BLACK + 'AL'
        map_matrix[a][b+1] = blColor(bl) + Fore.BLACK + 'ER'
        map_matrix[a+1][b+1] = blColor(bl) + Fore.BLACK + 'S'
