...
from characters import spawnBarbarian, move_barbarians, spawnArcher, move_archers, spawnSuperArcher, move_super_archers, spawnDragon, move_dragons, spawnBalloon, move_balloons, spawnHealer, move_healers,  clearTroops
...
os.system('clear')
build_level=int(input("Enter building level: "))
if build_level == 1:
    pt.level_of_building=1
elif build_level == 2:
    pt.level_of_building=2
elif build_level == 3:
    pt.level_of_building=3
elif build_level == 4:
    pt.level_of_building=4
elif build_level == 5:
    pt.level_of_building=5
else:
    pt.level_of_building=1
...
while(True):
    ...
    if ch == 'w':
        ...
        spawnSuperArcher(V.spawn_points[0])
    elif ch == 'y':
        spawnSuperArcher(V.spawn_points[1])
    elif ch == 'u':
        spawnSuperArcher(V.spawn_points[2])
    elif ch=='6':
    ...
    move_super_archers(V,pt.movement)
    move_healers(King,V)
    move_dragons(V)
    move_balloons(V)
